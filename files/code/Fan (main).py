...
def main():
    ...
    """
    # To this:
    # When an electrical signal is received, the fan turns on. If the signal does not arrive, it turns off.
...
if __name__ == "__main__":
    main()
    # And also this was added to execute the main infinitely:
    while True:
    	main()