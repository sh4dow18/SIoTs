...
def main():
	...
	# The broker add the users "admin", "cisco1", "cisco2" and "cisco3" automatically.
	mqttbroker.add_user("admin", "admin")
	mqttbroker.add_user("cisco1", "cisco1")
	mqttbroker.add_user("cisco2", "cisco2")
	mqttbroker.add_user("cisco3", "cisco3")
